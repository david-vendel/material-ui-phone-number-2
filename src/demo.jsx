...
export default render(
  <div style={{ fontFamily: "'Roboto', sans-serif", fontSize: '16px' }}>
    <div style={{ display: 'inline-block', verticalAlign: 'top' }}>
      ...
      <MaterialUiPhoneNumber defaultCountry="no" excludeCountries={['us', 'ca']} />
      <p>Only countries</p>
      <MaterialUiPhoneNumber defaultCountry="gb" onlyCountries={['gb', 'es']} />
      <p>Preferred countries</p>
      <MaterialUiPhoneNumber defaultCountry="it" preferredCountries={['it', 'se']} />
      <p>onChange</p>
      <ChangeDemo />
      <p>Native</p>
      <MaterialUiPhoneNumber defaultCountry="it" preferredCountries={['it', 'se']} native />
    </div>
    ...
    >
      ...
      <MaterialUiPhoneNumber defaultCountry="ca" regions={['north-america', 'carribean']} />
      <p>Disabled dropdown</p>
      <MaterialUiPhoneNumber onlyCountries={['us']} defaultCountry="us" disableDropdown placeholder="(702) 123-4567" />
